...
export default class Detail extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            Video ref = {
                (ref) => { this.videoPlayer = ref } }
            source = {
                { uri: util.video(data.qiniu_video) } }
            style = { styles.video }
            volume = { 5 }
            ...
            {
                !this.state.videoLoaded && < ActivityIndicator color = '#ee735c'
            ...
            <
            View style = {
                [styles.progressBar, { width: width * videoCompleted }] } > < /View> <
            /View> <
            /View> <
            CommentList rowData = { data }
